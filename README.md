...
- `original_notebook` исходный проект, сохранённый в формате Jupyter Notebook
...
- `all.py` изначальный проект, переписанный из Jupyter Notebook в стандартный файл .py
